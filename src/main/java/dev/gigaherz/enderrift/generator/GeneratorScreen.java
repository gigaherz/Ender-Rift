...
public class GeneratorScreen extends AbstractContainerScreen<GeneratorContainer>
{
    ...
    protected void renderLabels(GuiGraphics graphics, int mouseX, int mouseY)
    {
        ...
        if (generationPower > 0)
        {
            ...
            graphics.drawString(font, label, 8, 22, 0xFF404040, false);
            graphics.drawString(font, String.format("%d RF/t", generationPower), 12, 32, 0xFF404040, false);
        }
        ...
        graphics.drawString(font, label, 8, 46, 0xFF404040, false);
        ...
        graphics.drawString(font, str, imageWidth - 8 - font.width(str), 64, 0xFF404040, false);
    ...
    protected void renderBg(GuiGraphics graphics, float partialTicks, int mouseX, int mouseY)
    {
        ...
        if (clientFields.burnTimeRemaining > 0)
        {
            ...
            graphics.blit(RenderPipelines.GUI_TEXTURED, guiTextureLocation, leftPos + 80, topPos + 36 + 12 - k, 176, 12 - k, 14, k + 1, 256, 256);
        }
    ...
    private void drawEnergyBar(GuiGraphics graphics, int x, int y, int powerLevel, int powerLimit)
    {
        ...
        graphics.blit(RenderPipelines.GUI_TEXTURED, energyTextureLocation, x, y, bar1x, 0, barWidth, bar1height, 32, 64);
        graphics.blit(RenderPipelines.GUI_TEXTURED, energyTextureLocation, x, y + bar1height, bar2x, bar1height, barWidth, bar2height, 32, 64);
    }

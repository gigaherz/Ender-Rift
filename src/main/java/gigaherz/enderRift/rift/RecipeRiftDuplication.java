...
public class RecipeRiftDuplication implements ICraftingRecipe, net.minecraftforge.common.crafting.IShapedRecipe<CraftingInventory>
{
    private final ResourceLocation recipeId;
    private final IRecipeSerializer<?> serializer;

    public RecipeRiftDuplication(ResourceLocation recipeId, IRecipeSerializer<?> serializer)
    {
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<RecipeRiftDuplication>
    {
        @Override
        public RecipeRiftDuplication read(ResourceLocation recipeId, JsonObject json)
        {
            return new RecipeRiftDuplication(recipeId, this);
        }

        @Override
        public RecipeRiftDuplication read(ResourceLocation recipeId, PacketBuffer buffer)
        {
            return new RecipeRiftDuplication(recipeId, this);
        }

        @Override
        public void write(PacketBuffer buffer, RecipeRiftDuplication recipe)
        {

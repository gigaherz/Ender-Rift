...
public class InterfaceContainer extends Container
{
    ...
    protected InterfaceTileEntity tile;

    public InterfaceContainer(int id, PlayerInventory playerInventory, PacketBuffer extraData)
    {
        this(id, extraData.readBlockPos(), playerInventory);
    }

    public InterfaceContainer(int id, BlockPos pos, PlayerInventory playerInventory)
    {
        super(TYPE, id);
